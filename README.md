...
- **Melodía en pentagrama** *(en preparación, solo administradores)*: se escribe **con el ratón**
  sobre el pentagrama —que ya lleva **la armadura del tono**, con **las 15 duraciones** (5 figuras,
  sin puntillo, con uno y con dos)— o a mano en notación ABC, sección por sección, y se lee **como
  suena** o
  ...
  **Se escucha:** cada nota suena al colocarla, y un **reproductor** —reproducir, pausar, detener,
  tempo, metrónomo, repetir, **cuenta de entrada** y **volumen**, en 🎺 trompeta o 🎹 piano— la
  toca entera **coloreando la nota que suena**, en el editor y a pantalla completa. Suena **siempre en el tono real** (el del culto),
...
- [x] **Melodía en pentagrama** *(en preparación, solo administradores)*: escribirla con el ratón,
      **oírla nota a nota** (trompeta o piano), **reproducirla entera** con tempo, metrónomo,
      repetir, cuenta de entrada y volumen, **guardarla**, leerla como suena o como la lee la trompeta, y el tercer modo a
      pantalla completa
